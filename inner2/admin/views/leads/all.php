...
<div class="filter-form-wrap">
	<div class="beck-link">
		<a href="<?php echo inner_url('leads/resetfilter/'); ?>">איפוס הגדרות סינון</a>
	</div>
	<h4>סינון לידים</h4>
											...
											<div class="period-option-wrap selector-option-wrap" id="period_option_<?php echo $op_key; ?>">
												<table>
													<tr>
														...
														<td><img  data-val="<?php echo $op_key; ?>" data-str="<?php echo $option['str']; ?>" class="period-option period-option-search-icon selector-option selector-option-search-icon" src="<?php echo outer_url('style/image/Search-icon.png'); ?>" /></td>
													</tr>
												</table>
											</div>
										<?php endif; ?>
			...
			<tbody>			
				<?php foreach($leads as $lead) { $data=$lead->estimate_form_data; ?>
        			<tr>
						...
						<td data-title="צפייה בליד" class="numeric"><a href='<?php echo inner_url('leads/show/'); ?>?id=<?php echo $lead->id; ?>'>לחץ לצפייה</a></td>
        			</tr>	
