<div style="direction:rtl;">
	...
	<br/>
	<a href="<?php echo outer_url('userLogin/login'); ?>?sendAction=tokenSend&token=<?php print($token); ?>">לחץ כאן לאישור המייל וסיום ההרשמה</a>
	<br/><br/>
	לאחר סיום ההרשמה, תוכל לגשת אל 
	<a href="<?php echo outer_url(); ?>/"> מערכת שיתוף לידים </a>
	<br/><br/>
	שם משתמש: 
	...
	<a href="<?php echo outer_url(); ?>/">מערכת ניהול לידים</a>
</div>
